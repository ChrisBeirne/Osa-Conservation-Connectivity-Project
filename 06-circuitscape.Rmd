...
merged_shp <- st_read("data/input/area_of_interest/base_aoi.shp")
...
simple_cost <- read_stars("Data/output/Chapter5/Low_res_resistance_surface_final.tif")
simple_cost_terra <- rast("Data/output/Chapter5/Low_res_resistance_surface_final.tif")
# Make a new folder for the synthesis chapter 7
dir.create("data/output/Chapter7")

lc_key <- read.csv("data/input/landcover/ESACCI-LC_S2_Prototype_ColorLegend.csv", header=T, sep=";")
...
st_write(start_poly_17N, "Data/output/Chapter5/start_polygons_17N.shp", append=FALSE)
st_write(lowland_pa, "Data/output/Chapter5/start_polygons.shp", append=FALSE)
...
dir.create("Data/output/Chapter6/lowland_pa_all_low_res/")
path_text <- "Data/output/Chapter6/lowland_pa_all_low_res/"

# Import the costa layer
simple_cost <- read_stars("Data/output/Chapter5/Low_res_resistance_surface_final.tif")
plot(simple_cost)

simple_ras <- raster("Data/output/Chapter5/Low_res_resistance_surface_final.tif")
...
end_poly <- st_read("data/input/area_of_interest/high_elevation_pas.shp")
...
writeRaster(tmp,"Data/output/Chapter5/Low_res_resistance_surface_final_17N.tif" , overwrite=T)

cellmap <- raster("Data/output/Chapter5/Low_res_resistance_surface_final.tif")
...
lc <- rast("Data/output/Chapter5/Low_res_resistance_surface_final.tif")
start <- vect("Data/output/Chapter5/start_polygons.shp")
start_sf <- st_read("Data/output/Chapter5/start_polygons_17N.shp")
end <- vect("data/input/area_of_interest/high_elevation_pas.shp")
...
spaced_points_17N <- st_read("Data/output/Chapter5/start_points_1km_spacing.shp")
# Convert to points
...
# Plot the result
res_cur <- rast("data/output/Chapter6/lowland_pa_all_low_res/output/pas_lowres_curmap.asc")
# GIve it the crs
terra::crs(res_cur) <- "EPSG:4326"

res_volt <- rast("data/output/Chapter6/lowland_pa_all_low_res/output/pas_lowres_voltmap.asc")

end_poly <- vect("data/input/area_of_interest/high_elevation_pas.shp")
...
end_sf <- st_read("data/input/area_of_interest/high_elevation_pas.shp")
...
writeRaster(pa_cond_final, "data/output/Chapter7/Conductivity_pa_high_100m_res.tif", overwrite=T)
```
...
writeRaster(pa_cond_final, "data/output/Chapter7/central_america_connectivity_pa_size.tiff", overwrite=T)
writeRaster(pa_cond_final, "data/output/Chapter6/Climate_hub_current_and_resistance/Central_america_current.tif", overwrite=T)


lc <- rast("Data/output/Chapter5/Low_res_resistance_surface_final.tif")


writeRaster(lc, "data/output/Chapter6/Climate_hub_current_and_resistance/Central_america_conductance.tif", overwrite=T)
...
s <- st_read("data/output/Chapter7/draft_climate_hubs.shp")
...
# Normalised source
res_cur_norm <- rast("data/output/Chapter6/Coastal_pa_all_low_res/output/pas_lowres_normalised_curmap.asc")
...
res_cur_norm_mask <- mask(res_clamp, end_poly, inverse=T)
...
leaflet() %>%
  addProviderTiles("OpenStreetMap", group="OSM (default)") %>%
  addProviderTiles("Esri.WorldImagery", group="Satellite") %>%
  addRasterImage(res_cur_norm_ras, group="Raster", colors = pal) %>%  #  
  addPolygons(data=high_pa, fillColor = "black",
               label = high_pa$NAME, group="High_pa", stroke=F, fillOpacity = 1) %>% 
  addLayersControl(
    baseGroups = c("OSM (default)", "Satellite"),
    overlayGroups = c("Raster","High_pa")) %>%
...
writeRaster(res_cur_norm_mask, "data/output/Chapter7/central_america_connectivity_normalised.tiff", overwrite=T)
```
...
hubs <- vect("data/output/Chapter7/draft_climate_hubs.shp")

#Start and end polygons
start_all <- vect("data/input/protected_areas/lowland_protected_areas.shp")
end_all <- vect("data/input/area_of_interest/high_elevation_pas.shp")

# Start points
start_v <- vect("Data/output/Chapter5/start_points_1km_spacing.shp") #17N
start_v_wgs <- project(start_v, lc)


# MAke a folder to store the final (clamped) values for sharing
dir.create("Data/output/Chapter6/Climate_hub_current_and_resistance")
...
lc <- rast("Data/output/Chapter6/Case_study_1_Osa/cost_surface_100m.tif")
...
# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_1_Osa/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_1_Osa/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_1_Osa/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_1_Osa/output")
...
res_cur <- rast("Data/output/Chapter6/Case_study_1_Osa/output/Case_study_1_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/Osa_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/Osa_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_2/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_2/cost_surface_100m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_2/cost_surface_100m.tif")
aoi <- ext(lc) 
...
plot(sources_ras)
# Write the objects
dir.create("Data/output/Chapter6/Case_study_2")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_2/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_2/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_2/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_2/output")
...
res_cur <- rast("Data/output/Chapter6/Case_study_2/output/Case_study_1_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/Guanacaste_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/Guanacaste_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_3/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_3/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_3/cost_surface_300m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_3/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_3")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_3/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_3/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_3/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_3/output")
...
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_3/cost_surface_100m.tif")
lc_low <- rast("Data/output/Chapter6/Case_study_3/cost_surface_300m.tif")

aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_3/output/Case_study_3_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/SelvaMaya_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/SelvaMaya_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_4/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_4/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_4/cost_surface_300m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_4/cost_surface_100m.tif")
aoi <- ext(lc) 
...
plot(sources_ras)
# Write the objects
dir.create("Data/output/Chapter6/Case_study_4")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_4/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_4/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_4/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_4/output")
...
```{r, echo=F, message=F, warning=F}
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_4/cost_surface_300m.tif")
aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_4/output/Case_study_4_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/Belize_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/Belize_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_5/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_5/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_5/cost_surface_300m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_5/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_5")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_5/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_5/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_5/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_5/output")
...
```{r, echo=F, message=F, warning=F}
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_5/cost_surface_300m.tif")
aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_5/output/Case_study_5_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/Mostikia_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/Mostikia_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_6/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_6/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_6/cost_surface_200m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_6/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_6")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_6/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_6/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_6/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_6/output")
...
```{r, echo=F, message=F, warning=F}
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_6/cost_surface_200m.tif")
aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_6/output/Case_study_6_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/IndioMaiz_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/IndioMaiz.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_7/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_7/cost_surface_100m.tif", overwrite=TRUE)
#writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_7/cost_surface_200m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_7/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_7")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_7/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_7/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_7/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_7/output")
...
# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_7/output/Case_study_7_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/Amistad_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/Amistad_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_8/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_8/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_8/cost_surface_200m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_8/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_8")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_8/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_8/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_8/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_8/output")
...
```{r, echo=F, message=F, warning=F}
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_8/cost_surface_200m.tif")
aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_8/output/Case_study_8_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/Darien_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/Darien_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_9/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_9/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_9/cost_surface_200m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_9/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_9")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_9/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_9/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_9/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_9/output")
...
```{r, echo=F, message=F, warning=F}
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_9/cost_surface_200m.tif")
aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_9/output/Case_study_9_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/ElSalvador_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/ElSalvador_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_10/cellmap.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)
writeRaster(cost_final_ras, "Data/output/Chapter6/Case_study_10/cost_surface_100m.tif", overwrite=TRUE)
writeRaster(cost_final_ras_low, "Data/output/Chapter6/Case_study_10/cost_surface_200m.tif", overwrite=TRUE)

```


```{r, echo=F, eval=F, message=F, warning=F}
lc <- rast("Data/output/Chapter6/Case_study_10/cost_surface_100m.tif")
aoi <- ext(lc) 
...
# Write the objects
dir.create("Data/output/Chapter6/Case_study_10")

# Source
writeRaster(sources_ras, "Data/output/Chapter6/Case_study_10/sources.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Ground
writeRaster(grounds_ras, "Data/output/Chapter6/Case_study_10/grounds.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

# Polygon
writeRaster(polygons_ras, "Data/output/Chapter6/Case_study_10/regions_grid.asc", overwrite=TRUE, gdal="DECIMAL_PRECISION=0", NAflag=-9999)

dir.create("Data/output/Chapter6/Case_study_10/output")
...
```{r, echo=F, message=F, warning=F}
# Import the original cost surface
lc <- rast("Data/output/Chapter6/Case_study_10/cost_surface_200m.tif")
aoi <- ext(lc)

# Plot the result - TIME TAKEN 6454 seconds - will try with different solver
res_cur <- rast("Data/output/Chapter6/Case_study_10/output/Case_study_10_curmap.asc")
...
# Maps for sharing
writeRaster(final_cur, "Data/output/Chapter6/Climate_hub_current_and_resistance/HondurasVolcan_current.tif", overwrite=TRUE, NAflag=-9999)
writeRaster(lc, "Data/output/Chapter6/Climate_hub_current_and_resistance/HondurasVolcan_conductance.tif", overwrite=TRUE, NAflag=-9999)
...
# Create folders to store the results
dir.create("Data/output/Chapter6/High_connectivity_low_res")
path_text <- "Data/output/Chapter6/High_connectivity_low_res"

# read them back in with the raster package
end_polygons <- raster("Data/output/Chapter6/Coastal_pa_all_low_res/end_poly_stars.tif")
grounds_polygons <- raster("Data/output/Chapter6/Coastal_pa_all_low_res/grounds_stars.tif")
cellmap <- raster("Data/output/Chapter5/Low_res_resistance_surface.tif")
