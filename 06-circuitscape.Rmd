...
simple_cost_terra <- rast("Data/Chapter5/Low_res_resistance_surface.tif")
...
nrow(test)
length(unique(coastal_pa_filtered$NAME))
# Check the areas
...
# Raw current
#plot(res_cur)
res_clamp <- clamp(res_cur, upper=80)
# Make low current NA
