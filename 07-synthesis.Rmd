...
high_pa <- vect("data/input/area_of_interest/high_elevation_pas.shp")
...
plot(high_forest_sf)
st_write(high_forest_sf, "data/output/Chapter7/high_forest_sf.shp")

```


```{r, message=F, warning=F, echo=F, include=F}
high_forest_sf <- st_read("data/output/Chapter7/high_forest_sf.shp")
...
# Import the protected areas
low_pa <- vect("data/input/protected_areas/lowland_protected_areas.shp")
...
st_write(low_forest_sf, "data/output/Chapter7/low_forest_sf.shp")
```
...
low_pa <- vect("data/input/protected_areas/lowland_protected_areas.shp")
low_pa_sf <- sf::st_as_sf(low_pa)
low_forest_sf <- st_read("data/output/Chapter7/low_forest_sf.shp")
...
ter_finalists_shp_wgs <- st_read("data/output/Chapter7/final_ter_lcps.shp")
...
continental_divide <- st_read("data/input/hybas_na_lev01-12_v1c/hybas_na_lev02_v1c.shp")
watersheds <- st_read("data/input/hybas_na_lev01-12_v1c/hybas_na_lev07_v1c.shp")
...
st_write(subwatersheds_17N, "Data/output/Chapter7/watershed_conductivity.shp" )
```

```{r, include=F}
subwatersheds_17N<- st_read("Data/output/Chapter7/watershed_conductivity.shp")
